...
<head>
    ...
    <title>:: Demandas Canceladas ::</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <!-- /.panel-heading -->
<?php
   $result = mysql_query("SELECT * FROM demandas WHERE status = '4 - Cancelado' ORDER BY status ASC");
   $num_rows = mysql_num_rows($result);
   $query = sprintf("SELECT * FROM demandas WHERE status = '4 - Cancelado' ORDER BY status ASC");
