...
include('nomesgrupos.php');
   ...
   $query = sprintf("SELECT foto, idcliente, nome, descricao, profissao, responsavel, sexo, data_cadastro FROM clientes ORDER BY idcliente DESC LIMIT 100");
...
?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Pessoas Cadastradas (Ultimos 100 Cadastrados)</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
