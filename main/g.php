...
include('nomesgrupos.php');
   ...
   $result = mysql_query("SELECT foto, idcliente, nome, descricao, profissao, responsavel, sexo, data_cadastro FROM clientes WHERE ".$_GET['g']." = 'S' ORDER BY idcliente DESC");
   $num_rows = mysql_num_rows($result);
   $query = sprintf("SELECT foto, idcliente, nome, descricao, profissao, responsavel, sexo, data_cadastro FROM clientes WHERE ".$_GET['g']." = 'S' ORDER BY idcliente DESC");
...
?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Pessoas Cadastradas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
