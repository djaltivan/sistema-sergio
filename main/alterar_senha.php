    ...
    if($login == "" || $login == null){
        echo"<script language='javascript' type='text/javascript'>alert('O campo login deve ser preenchido');window.location.href='editar_usuario.php';</script>";
            ...
            if($logarray == $senha){
                ...
                echo"<script language='javascript' type='text/javascript'>alert('Essa senha é a cadastrada, digite uma nova senha');window.location.href='editar_usuario.php';</script>";
                die();
                ...
                if($insert){
                    echo"<script language='javascript' type='text/javascript'>alert('Não foi possível alterar a senha');window.location.href='editar_usuario.php'</script>";
                }else{
